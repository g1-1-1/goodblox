...
$stmt1->bindValue(':id', $users['id'], PDO::PARAM_INT);
...
$stmt2->bindValue(':id', $users['id'], PDO::PARAM_INT);
...
$stmt3->bindValue(':id', $users['id'], PDO::PARAM_INT);
...
$stmt4->bindValue(':id', $users['id'], PDO::PARAM_INT);
...
$stmt45->bindValue(':id', $users['id'], PDO::PARAM_STR);
...
$stmt455->bindValue(':id', $users['id'], PDO::PARAM_STR);
...
--plr.CharacterAppearance = "https://www.madblxx.gq/api/charapp.php?id='.(int)$users["id"].'"
plr:LoadCharacter(false)

plr.Character.Torso.BrickColor = BrickColor.new("'.$users["torsocolor"].'")
plr.Character.Head.BrickColor = BrickColor.new("'.$users["headcolor"].'")
plr.Character["Right Leg"].BrickColor = BrickColor.new("'.$users["rightlegcolor"].'")
plr.Character["Right Arm"].BrickColor = BrickColor.new("'.$users["rightarmcolor"].'")
plr.Character["Left Leg"].BrickColor = BrickColor.new("'.$users["leftlegcolor"].'")
plr.Character["Left Arm"].BrickColor = BrickColor.new("'.$users["leftarmcolor"].'")
...
header('location: renderall.php?id='. $id++);
